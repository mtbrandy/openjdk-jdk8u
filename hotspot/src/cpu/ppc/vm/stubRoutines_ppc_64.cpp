...
void StubRoutines::ppc64::generate_load_crc_short_constants_addr(MacroAssembler* masm, Register table) {
  __ load_const_optimized(table, (address)StubRoutines::ppc64::_short_constants, R0);
}
...
juint StubRoutines::ppc64::_constants[CRC32_CONSTANTS_SIZE] = {
...
juint StubRoutines::ppc64::_short_constants[CRC32_SHORT_CONSTANTS_SIZE] = {
    0xec447f11UL, 0x99168a18UL, 0x13e8221eUL, 0xed837b26UL,
    0x8fd2cd3cUL, 0xe23e954eUL, 0x47b9ce5aUL, 0xc8acdd81UL,
    0x6b1d2b53UL, 0x92f8befeUL, 0xd4277e25UL, 0xd9ad6d87UL,
    0x291ea462UL, 0xf38a3556UL, 0x33fbca3bUL, 0xc10ec5e0UL,
    0x62b6ca4bUL, 0x974ac562UL, 0x82e02e2fUL, 0xc0b55b0eUL,
    0x784d2a56UL, 0x855712b3UL, 0xe172334dUL, 0x71aa1df0UL,
    0x0eaee722UL, 0xa5abe9f8UL, 0x3969324dUL, 0xfee3053eUL,
    0xdb54814cUL, 0x1fa0943dUL, 0x3eb2bd08UL, 0xf44779b9UL,
    0xd7bbfe6aUL, 0xa53ff440UL, 0x00cc3374UL, 0xf5449b3fUL,
    0x6325605cUL, 0xebe7e356UL, 0xd777606eUL, 0x6f8346e1UL,
    0xe5b592b8UL, 0xc65a272cUL, 0xc0b95347UL, 0xe3ab4f2aUL,
    0x4721589fUL, 0x5705a9caUL, 0x329ecc11UL, 0xaa2215eaUL,
    0x88d14467UL, 0xe3720acbUL, 0xd95efd26UL, 0x1ed8f66eUL,
    0x15141c31UL, 0xba1aca03UL, 0xa700e96aUL, 0x78ed02d5UL,
    0xed627daeUL, 0xad2a31b3UL, 0x32b39da3UL, 0xba8ccbe8UL,
    0xa06a2517UL, 0x6655004fUL, 0xb1e6b092UL, 0xedb88320UL
};

juint StubRoutines::ppc64::_barret_constants[CRC32_BARRET_CONSTANTS] = {
