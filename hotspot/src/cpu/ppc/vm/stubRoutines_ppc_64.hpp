...
#endif
#define CRC32_CONSTANTS_SIZE 1020
#define CRC32_SHORT_CONSTANTS_SIZE 64
...
class ppc64 {
 ...
 private:
  ...
  static juint _constants[CRC32_CONSTANTS_SIZE];
  static juint _short_constants[CRC32_SHORT_CONSTANTS_SIZE];
  static juint _barret_constants[CRC32_BARRET_CONSTANTS];
 ...
 public:
  ...
  static void generate_load_crc_short_constants_addr(MacroAssembler* masm, Register table);
